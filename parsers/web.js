(function() {
  ...
  define(['./brent-rjs', './text!./units.json'], function(brent, data) {
    var AddExpression, BinaryOperation, CallExpression, DivExpression, ExecutionContext, ExpExpression, Expression, MulExpression, NegExpression, NumExpression, ParenExpression, StringExpression, SubExpression, UNITLESS, UnitNum, VarExpression, applyObj, checkObj, compositeObj, exports, functionScope, fundamental, fundamentals, getSigFigs, objEquals, parseMap, parseUnit, units, _i, _len;
    exports = {};
    ...
    exports.UnitNum = UnitNum = (function() {
      ...
      UnitNum.prototype.add = function(other) {
        ...
        if (!objEquals(this.unit, other.unit)) {
          console.log(this.unit, other.unit);
    ...
    functionScope = {
      ...
      'log': function(scope, desiredUnits, n) {
        console.log(n.express(desiredUnits), n.terms(desiredUnits).displayNum);
    ...
    exports.ExecutionContext = ExecutionContext = (function() {
      ...
      ExecutionContext.prototype.execute = function(line) {
        ...
        if (parsed[0] === 'ASSIGN') {
          ...
          rstr += "" + parsed[1] + " = " + (this.scope[parsed[1]].express(this.usingUnits));
        } else {
